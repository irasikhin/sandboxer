...
// catalog. deepseek-v4.1-flash is the day-one entry: the baked pi release
// predates the model, and it runs on the deepseek provider the image already
// wires (DEEPSEEK_API_KEY auth, api.deepseek.com in the default allowlist).
//
