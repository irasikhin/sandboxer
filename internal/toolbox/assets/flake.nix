    ...
    in
    {
      packages = forSystems (
        ...
        let
          ...
          userFiles = lib.mapAttrsToList (
            path: text: pkgs.writeTextDir (lib.removePrefix "/" path) text
          ) (user.files or { });
          ...
          toolPkgs = map (
            n:
            lib.attrByPath (lib.splitString "." n) (throw "sandboxer: unknown nixpkgs attribute '${n}' (tools/extraPkgs)") pkgs
          ) toolNames;
