...
under ../<project>-sandboxes/<slug>/<repo>/<branch> (relocatable via the
profile's worktreesDir) — every source names its branch explicitly, and its
directory is named after it. The container
