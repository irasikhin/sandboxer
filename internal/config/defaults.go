...
// regions/accounts as well. Docker Hub ALSO serves blobs from its own CDN
// hostnames — production.cloudflare.docker.com (historical) and
// production.cloudfront.docker.com (the live one since 2026; observed — the
// name-bound deny of the new CDN host failed every pull at the blob stage).
// Without the CDN names in the list a pull dies halfway through the manifest.
